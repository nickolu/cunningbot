...
async def validate_answer(user_answer: str, correct_answer: str, question: str) -> Dict[str, any]:
    """
    Use LLM to determine if user's answer is correct, handling variations.
