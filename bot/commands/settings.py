    ...
    async def set_personality_setting(self, interaction: discord.Interaction, value: Optional[str] = None) -> None:
        ...
        if value and value.lower() == "get":
            ...
            if current_pers:
                ...
                await interaction.response.send_message("No personality is currently set.", ephemeral=True)
            return
        ...
        try:
            ...
            if value:
                ...
                await interaction.response.send_message("Personality setting cleared.", ephemeral=True)
        except ValueError as e:
            await interaction.response.send_message(f"Error: {str(e)}", ephemeral=True)
        except Exception as e:
            # Consider logging the error e
            await interaction.response.send_message("An unexpected error occurred while updating the personality setting.", ephemeral=True)
